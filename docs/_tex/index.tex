...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, colback=white, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, leftrule=.75mm, titlerule=0mm, bottomtitle=1mm, opacitybacktitle=0.6, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The Language Manchu}, toptitle=1mm, left=2mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, colback=white, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, leftrule=.75mm, titlerule=0mm, bottomtitle=1mm, opacitybacktitle=0.6, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The issue of Transliteration Alignment}, toptitle=1mm, left=2mm, coltitle=black]
